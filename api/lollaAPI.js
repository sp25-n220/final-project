...
router.get("/lollaSchedule", async (req, res, next) => {
    try {
...
// lollaSchedule
router.post("/lollaSchedule", async (req, res, next) => {
    try {
...
// UPDATE schedule
router.put("/lollaSchedule/:scheduleId", async (req, res, next) => {
    try {
...
router.delete("/lollaSchedule/:scheduleId", async (req, res, next) => {
    try {
      const scheduleId = parseInt(req.params.scheduleId, 10);
